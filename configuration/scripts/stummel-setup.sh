...
ros_distro=melodic
ros_packages="ros-${ros_distro}-perception ros-${ros_distro}-desktop-full ros-${ros_distro}-qt-gui-core python-rosinstall ros-${ros_distro}-moveit-core ros-${ros_distro}-moveit-ros-planning ros-${ros_distro}-moveit-ros-planning-interface ros-${ros_distro}-sound-play ros-${ros_distro}-urg-node python-catkin-tools"
