    ...
    : wm(wm)
{
    ...
    else
    {
        ...
        topic = (*sc)["StummelWorldModel"]->get<string>("Data.OdomPosition.Topic", NULL);
        odomSub = n.subscribe(topic, 10, &Communication::onOdomMsg, (Communication *)this);

        topic = (*sc)["StummelWorldModel"]->get<string>("Data.BatteryVoltage.Topic", NULL);
        batteryVoltageSub = n.subscribe(topic, 10, &Communication::onBatteryVoltage, (Communication *)this);
    }
